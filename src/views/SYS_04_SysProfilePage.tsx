...
function NavButton({ active, onClick, label, desc }: any) {
  return (
    <button
      onClick={onClick}
      className={`group w-full border-l-2 px-4 py-4 text-left transition-all ${
        active
...
function ThemeOption({ icon, label, active, onClick }: any) {
  return (
    <button
      onClick={onClick}
      className={`flex flex-col items-center justify-center gap-3 border p-6 transition-all ${
        active
