# Frontend Technical Documentation Register – `Global`
...
|---|---|---|---|
| **REG** | `Frontend Completion Pack – REG Series` | **Complete** | `/docs/03-features/reg-series-completion.md` |
| **META** | `Frontend Completion Pack – META Series` | **Complete** | `/docs/03-features/meta-series-completion.md` |

### B. Technical Specifications

| #  | Document Type | Title / Description | Location | Status |
|----|---|---|---|---|
| 1  | **Master Guidelines** | `NexusCanon UX & Behavior Guidelines` | `/docs/01-foundations/guidelines.md` | **Final** |
| 2  | **Global Tech Doc** | `Frontend Technical Documentation Register` | `/docs/02-architecture/technical-register.md` | **Active** |
| 3  | **Design System** | `Forensic UI System` | `/docs/01-foundations/design-system.md` | **Live** |
| 4  | **Routing Map** | `App Routing Architecture` | `/App.tsx` | **Live** |
| 5  | **State Management** | `Shell & Navigation State` | `/lib/stateManager.ts` | **Live** |
