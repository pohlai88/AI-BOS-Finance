# META NAVIGATION & AUDIT TRAIL SYSTEM
...
**Recommended Events:**
- `meta_nav_opened` - User opened navigation overlay
- `meta_nav_module_selected` - User navigated to module
- `audit_trail_full_history_viewed` - User expanded full history
- `audit_trail_version_compared` - User compared versions (future)
...
- **Navigation Design:** `/docs/META_NAV_DESIGN.md`
- **Component Specs:** See individual component files
- **Meta Pages:** `/pages/Metadata*.tsx`
