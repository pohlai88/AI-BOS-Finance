...
export type EntityType = 'HQ' | 'Holding' | 'Subsidiary' | 'Branch' | 'JV' | 'Associate';
export type EntityStatus = 'Active' | 'Dormant' | 'Winding-up' | 'Dissolved';
export type ShareClass = 'Common' | 'Preferred' | 'Preferred-A' | 'Preferred-B' | 'Others';
export type ShareholderType = 'Company' | 'Individual' | 'Trust' | 'Fund' | 'Government';
...
export type ValidationStatus = 'UNVERIFIED' | 'PENDING_REVIEW' | 'VERIFIED' | 'REJECTED';
export type ValidationLevel = 'L1_REGEX' | 'L2_DOC_VERIFIED' | 'L3_API_VERIFIED';
export type BankRelationshipType = 'Operating' | 'Loan' | 'Custody' | 'Investment';
export type DirectorRole = 'Chair' | 'Director' | 'Independent' | 'Executive' | 'Non-Executive';
export type OfficerRole = 'Legal Rep' | 'GM' | 'CEO' | 'CFO' | 'COO' | 'Company Secretary';
 ...
 */
export function calculateConsolidationMethod(ownershipPercent: number): ConsolidationMethod {
 ...
 */
export function calculateGovernanceCompleteness(entity: EntityGovernance): number {
