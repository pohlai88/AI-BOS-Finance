...
const RISK_SCENARIOS = [
  {
    msg: 'Rev Rec variance detected (ASC-606)',
    sev: 'medium' as Severity,
    layer: 'IFRS' as Layer,
  },
  {
    msg: 'Vendor drift > 2.5% vs PO',
    sev: 'low' as Severity,
    layer: 'COSO' as Layer,
  },
  {
    msg: 'CRITICAL: Shadow Ledger anomaly',
    sev: 'critical' as Severity,
    layer: 'SOX' as Layer,
  },
  {
    msg: 'Tax jurisdiction mismatch (EU/US)',
    sev: 'high' as Severity,
    layer: 'TAX' as Layer,
  },
  {
    msg: 'Canon hash verified: Block #9921',
    sev: 'low' as Severity,
    layer: 'SOX' as Layer,
  },
  {
    msg: 'IFRS 15 timing violation flagged',
    sev: 'high' as Severity,
    layer: 'IFRS' as Layer,
  },
  {
    msg: 'Control test passed: AP-003',
    sev: 'low' as Severity,
    layer: 'COSO' as Layer,
  },
  {
    msg: 'Materiality threshold exceeded',
    sev: 'medium' as Severity,
    layer: 'TAX' as Layer,
  },
  {
    msg: 'Circular revenue pattern detected',
    sev: 'critical' as Severity,
    layer: 'IFRS' as Layer,
  },
  {
    msg: 'SOX 404 control gap resolved',
    sev: 'low' as Severity,
    layer: 'SOX' as Layer,
  },
]
...
export const useRiskTelemetry = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      const scenario =
        RISK_SCENARIOS[Math.floor(Math.random() * RISK_SCENARIOS.length)]
      const now = new Date()
