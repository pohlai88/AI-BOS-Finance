...
export const ThreatRadar = ({
  ...
  const points: RadarPoint[] = useMemo(() => {
    return Array.from({ length: Math.min(activeRisks * 2, 12) }).map(
      (_, i) => ({
        id: `threat-${i}`,
    ...
    <div className={cn('flex flex-col gap-4', className)}>
      ...
      >
        ...
        <div className="absolute left-4 top-4 z-20">
          <motion.div
            className="flex items-center gap-2 rounded-full border bg-black/80 px-3 py-1.5 backdrop-blur-md"
            style={{
              borderColor: crystallized
                ? theme.color
                : lynxActive
                  ? LYNX_GREEN
                  : theme.color,
          ...
          >
            {crystallized ? (
              ...
              <Activity className="h-4 w-4" style={{ color: theme.color }} />
            )}
            <span
        ...
        <div className="relative flex items-center justify-center p-2">
          ...
          <div className="relative" style={{ width: size, height: size }}>
            <RadarDisplay config={config} points={points} />
            ...
            >
              ...
              <g stroke={theme.color} strokeWidth="2" strokeOpacity="0.5">
                ...
                <path
                  d={`M ${size - 15} 35 L ${size - 15} 15 L ${size - 35} 15`}
                  fill="none"
                />
                <path
                  d={`M 15 ${size - 35} L 15 ${size - 15} L 35 ${size - 15}`}
                  fill="none"
                />
                <path
                  d={`M ${size - 15} ${size - 35} L ${size - 15} ${size - 15} L ${size - 35} ${size - 15}`}
                  fill="none"
                />
              </g>
            ...
            */}
            ...
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
              <motion.div
                className="relative flex flex-col items-center justify-center overflow-visible rounded-full border-2"
                style={{
                  width: 90,
                  height: 90,
              ...
              >
                ...
                {crystallized ? (
                  ...
                  <>
                    ...
                    <span
                      className="mt-0.5 font-mono text-[8px] uppercase tracking-[0.15em]"
