    ...
    >
      ...
      <div className="p-8 z-10">
        <div className="flex items-center gap-3 mb-4">
          <div className="p-2 rounded-lg bg-white/5 border border-white/5 text-nexus-green group-hover:text-white group-hover:bg-nexus-green/10 transition-colors">
        ...
        <p className="text-sm text-nexus-noise leading-relaxed max-w-[90%]">
          {description}
        </p>
      </div>
