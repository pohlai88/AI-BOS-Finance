...
export const MagicUIRadar = ({ activeRisks, className }: MagicUIRadarProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 rounded-2xl border border-white/10 bg-[#020617]">
        {/* Atmospheric haze */}
        <div
        ...
        <AnimatePresence>
          {isWarning && (
            ...
            >
              <div
                className="animate-pulse-glow h-48 w-48 rounded-full border-2"
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center">
          ...
          >
            ...
            {/* Label */}
            <span className="mt-1 font-mono text-[10px] uppercase tracking-[0.2em] text-white/60">
              Threats
            </span>
        ...
        <div className="absolute bottom-6 left-1/2 z-20 -translate-x-1/2">
          <motion.div
            className="flex items-center gap-2 rounded-full border bg-black/80 px-4 py-2 backdrop-blur-md"
            style={{ borderColor: theme.color }}
          ...
          >
            {isCritical ? (
              ...
              <ShieldCheck className="h-4 w-4" style={{ color: '#84CC16' }} />
            ) : (
              <Lock className="h-4 w-4" style={{ color: theme.color }} />
            )}
            <span
        ...
        {/* Corner markers */}
        <div
          className="absolute left-4 top-4 h-8 w-8 border-l-2 border-t-2 opacity-30"
          style={{ borderColor: theme.color }}
        />
        <div
          className="absolute right-4 top-4 h-8 w-8 border-r-2 border-t-2 opacity-30"
          style={{ borderColor: theme.color }}
        />
        <div
          className="absolute bottom-4 left-4 h-8 w-8 border-b-2 border-l-2 opacity-30"
          style={{ borderColor: theme.color }}
        />
        <div
          className="absolute bottom-4 right-4 h-8 w-8 border-b-2 border-r-2 opacity-30"
          style={{ borderColor: theme.color }}
        />
