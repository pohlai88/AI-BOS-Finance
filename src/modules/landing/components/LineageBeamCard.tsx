...
export const LineageBeamCard = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="group relative h-64 w-full max-w-4xl overflow-hidden rounded-2xl border border-white/10 bg-[#0A0A0A] transition-colors duration-500 hover:border-green-500/30"
    >
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-between px-16">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 z-0 animate-pulse rounded-full bg-green-500/20 blur-xl" />
        </div>
      ...
      {/* Title */}
      <div className="absolute bottom-4 left-6 font-mono text-xs uppercase tracking-widest text-gray-500">
...
const Node = ({
  ...
  >
    <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-white/10 bg-[#111] shadow-2xl backdrop-blur-md">
