...
} from '@/mock-data/mockEntityGovernance'
import type { EntityGovernance } from '@/modules/system/types/entity-governance'
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 space-y-2">
                  ...
                  <p className="font-mono text-sm text-zinc-500">
                    {entity.profile.entityCode} Â·{' '}
                    {entity.profile.countryOfIncorporation} Â·{' '}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <button
                    ...
                    className={`relative h-10 border px-4 font-mono text-[10px] uppercase tracking-[0.15em] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/40 ${hasAnyChanges
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="font-mono text-[9px] text-amber-400">
                      âš ï¸ Cannot consolidate until verified
                    </div>
                  </div>
                </motion.div>
              )}
                ...
                <td colSpan={3} className="px-3 py-2">
                  {entity.computed.ownershipBalance !== 0 && (
                    <span className="text-[9px] text-amber-500">
                      âš ï¸ Balance: {entity.computed.ownershipBalance}%
                    </span>
                  )}
                </td>
              </tr>
          ...
          <div className="border border-[#1F1F1F] bg-[#050505] p-3">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-[10px]">
                ...
                <span
                  className={`font-mono ${entity.validation.status === 'VERIFIED'
                    ? 'text-emerald-500'
                    : 'text-amber-500'
                    }`}
                >
