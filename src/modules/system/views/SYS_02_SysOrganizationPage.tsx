...
import { MOCK_ENTITY_GOVERNANCE } from '@/mock-data/mockEntityGovernance'
        ...
        <div className="z-10 w-full max-w-[1280px] space-y-6">
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <button
                    ...
                    className={`relative h-10 border px-4 font-mono text-[10px] uppercase tracking-[0.15em] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/40 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0A] ${hasAnyChanges && !isSavingAll
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <NexusBadge variant="neutral">
                      Tenant: Nexus Group â€“ Production
                    </NexusBadge>
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <CardSection
              ...
              subtitle="12 Entities Â· 3 Countries"
              badge={
            ...
            <CardSection
              ...
              subtitle="MY01 Â· Nexus Farming MY"
              compact
              badge={
