      ...
      <div className="flex gap-4 max-w-4xl w-full">
        ...
        <div className="flex-1 bg-[#050505] border border-[#28E7A2] relative overflow-hidden group">
          ...
          <div className="p-6 border-b border-[#1F1F1F] bg-[#0A0A0A] relative">
            ...
            <p className="text-lg text-white font-light leading-relaxed">{data.directAnswer}</p>
          </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <svg viewBox="0 0 600 160" className="w-full h-full max-w-3xl px-8 select-none">
                  ...
                  <g transform="translate(100, 80)">
                    ...
                    <text
                      y="32"
                      textAnchor="middle"
                      className="fill-[#444] text-[9px] font-mono tracking-wider"
                    >
                      SOURCE: LEDGER
                    </text>
                  </g>
                  ...
                  <g transform="translate(300, 80)">
                    ...
                    <text
                      y="-40"
                      textAnchor="middle"
                      className="fill-red-500 text-[8px] font-mono tracking-widest uppercase"
                    >
                      MANUAL_INTERCEPT
                    </text>
                  </g>
                ...
                <div className="absolute bottom-4 right-6 max-w-[240px] bg-black/90 backdrop-blur border border-red-500/30 p-3 shadow-2xl">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[9px] text-[#666] font-mono uppercase">
                      Vector Analysis
                    </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-6 border-b border-[#1F1F1F]">
              ...
              <div className="space-y-4">
                <div>
                  <span className="text-[10px] text-[#555] font-mono uppercase block mb-1">
                    Primary Standard
                  </span>
                  <span className="text-xs text-white border-b border-[#333] pb-0.5">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {data.standards.supporting.map((s, i) => (
                      <span
                        key={i}
                        className="text-[10px] text-[#888] bg-[#111] px-1.5 py-0.5 border border-[#222]"
                      >
                        {s}
                      </span>
                    ))}
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              {data.evidence.stats.map((stat, i) => (
                <div key={i} className="bg-[#000] border border-[#222] p-3">
                  <div className="text-[9px] text-[#555] font-mono uppercase mb-1">
                    {stat.label}
                  </div>
                  <div className="text-lg font-mono" style={{ color: stat.color || '#FFF' }}>
                    {stat.value}
                  </div>
                </div>
              ))}
            ...
            <div className="p-6 border-r border-[#1F1F1F] bg-[#0F0505]">
              ...
              <div className="flex gap-2 mb-3">
                {data.risk.types.map((type, i) => (
                  <span
                    key={i}
                    className="text-[9px] text-red-400 border border-red-900/30 bg-red-900/10 px-1.5 py-0.5"
                  >
                    {type}
                  </span>
                ))}
              </div>
              <p className="text-xs text-[#888] leading-relaxed">{data.risk.impact}</p>
            </div>

            <div className="p-6 bg-[#050F0A]">
              <div className="flex items-center gap-2 mb-3">
                <Shield className="w-4 h-4 text-[#28E7A2]" />
                <span className="text-xs font-mono text-[#28E7A2] uppercase tracking-wider">
                  Recommended Action
                </span>
              </div>
          ...
          <div className="p-3 bg-[#000] border-t border-[#1F1F1F] flex items-center justify-end gap-3">
            {data.links.map((link, i) => (
              <button
                key={i}
                className="flex items-center gap-2 text-[10px] font-mono text-[#666] hover:text-[#28E7A2] transition-colors border border-transparent hover:border-[#222] px-2 py-1"
              >
