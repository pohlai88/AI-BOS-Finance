  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? 'bg-nexus-void/80 backdrop-blur-md border-b border-nexus-structure'
    ...
    >
      <div className="w-full max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <a
            href="#lineage"
            className="text-xs font-mono text-nexus-noise hover:text-nexus-green uppercase tracking-widest transition-colors"
          >
            Simulation
          </a>
          <a
