          ...
          <div className="p-4 grid grid-cols-2 gap-3">
            {tasks.map((task) => (
              ...
              >
                ...
                <div className={`mb-3 ${task.status === 'completed' ? 'text-emerald-500' : 'text-zinc-400 group-hover:text-emerald-400'}`}>
                  {task.icon}
                </div>
      ...
      >
        <div className="relative w-10 h-10 flex items-center justify-center">
          <svg className="w-10 h-10 -rotate-90">
            <circle cx="20" cy="20" r="16" className="stroke-[#222]" strokeWidth="3" fill="transparent" />
            <circle 
              cx="20" cy="20" r="16" 
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            {isOpen ? <ChevronDown className="w-3 h-3 text-white" /> : <ChevronUp className="w-3 h-3 text-white" />}
          </div>
        </div>
