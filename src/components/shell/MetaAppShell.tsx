      ...
      <header className="fixed top-0 left-0 right-0 h-16 border-b border-[#1F1F1F] bg-black/80 backdrop-blur-md z-40 flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#0A0A0A] border border-[#1F1F1F]">
            ...
            <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">Online</span>
          </div>
          
          <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-zinc-800 to-zinc-700 border border-[#333] flex items-center justify-center cursor-pointer hover:border-emerald-500/50 transition-colors" onClick={() => navigate('/sys-profile')}>
