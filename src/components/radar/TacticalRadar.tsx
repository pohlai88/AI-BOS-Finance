    ...
    <div className={cn('flex flex-col items-center gap-4', className)}>
      ...
      {showHeader && (
        <div className="text-center">
          ...
          <p className="font-mono text-xs tracking-wider text-cyan-400/60">
      ...
      {/* Radar Container */}
      <div className="relative rounded-lg border border-cyan-900/30 bg-[#0a1628] p-4">
        {/* Corner brackets */}
        <div className="absolute left-2 top-2 h-4 w-4 border-l-2 border-t-2 border-cyan-500/40" />
        <div className="absolute right-2 top-2 h-4 w-4 border-r-2 border-t-2 border-cyan-500/40" />
        <div className="absolute bottom-2 left-2 h-4 w-4 border-b-2 border-l-2 border-cyan-500/40" />
        <div className="absolute bottom-2 right-2 h-4 w-4 border-b-2 border-r-2 border-cyan-500/40" />
