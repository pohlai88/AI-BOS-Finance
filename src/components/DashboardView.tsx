...
import { FileText, Download, Search, TrendingUp, AlertCircle, ChevronRight, RotateCcw } from 'lucide-react';
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-medium mb-2 text-green-400">
                Your Reports Are Ready!
              </h2>
              <p className="text-gray-400 mb-4">
                We&apos;ve processed your data and generated IFRS-compliant reports. 
                All numbers are traced to their source and ready for audit.
              </p>
...
const ReportCard = ({
  ...
  >
    <div className="flex items-start justify-between mb-4">
      ...
      <ChevronRight className={`w-5 h-5 transition-all ${isSelected ? 'text-green-400' : 'text-gray-600 group-hover:translate-x-1'}`} />
    </div>
