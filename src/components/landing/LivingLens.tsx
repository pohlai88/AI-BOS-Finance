...
import { FileText, ArrowRight, CheckCircle, XCircle, AlertTriangle, Play, Pause } from 'lucide-react';
// IMPORT THE BRAIN
  ...
  return (
    <div className="w-full max-w-6xl mx-auto min-h-[550px] flex flex-col gap-6">
      ...
      <div className="w-full flex gap-8 bg-zinc-950/50 border border-white/10 rounded-2xl p-8 relative overflow-hidden">
        ...
        <div className="w-1/3 relative z-10 flex flex-col">
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="text-right">
                  <div className="text-white font-mono text-xl">${currentTx.amount.toLocaleString()}</div>
              ...
              <div className="space-y-2 pt-3 border-t border-white/5">
                ...
                <div className="flex justify-between text-[12px]">
                  <span className="text-zinc-600 font-mono uppercase tracking-wider">Customer?</span>
                  <span className={`font-mono ${currentTx.is_existing_customer ? 'text-yellow-400' : 'text-zinc-400'}`}>
          ...
          <div className="mt-6 space-y-2">
            <div className="text-[12px] font-mono text-zinc-600 uppercase tracking-wider">Next in Queue</div>
            {TRANSACTION_STREAM.slice(index + 1, index + 3).map((tx, i) => (
              <div key={tx.id} className="p-2 rounded bg-zinc-900/50 border border-white/5 flex items-center gap-2">
        ...
        <div className="flex-1 relative z-10 flex flex-col">
          <div className="text-[12px] font-mono text-zinc-500 uppercase tracking-widest mb-4 flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-emerald-500" style={{ 
              animation: auditResult.riskLevel === 'CRITICAL' ? 'pulse 1s ease-in-out infinite' : 'none' 
            }} />
            NexusCanon Engine
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex justify-between items-center border-b border-white/10 pb-4 mb-6">
                <span className="text-zinc-400 text-[14px] font-mono uppercase tracking-wider">Risk Assessment</span>
                <motion.span
                  initial={{ scale: 0.8 }}
                  animate={{ scale: 1 }}
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-zinc-900/50 border border-white/5 rounded-lg">
        ...
        <div className="text-[12px] font-mono text-zinc-600">
          Processing at 250ms/transaction
        </div>
      </div>
