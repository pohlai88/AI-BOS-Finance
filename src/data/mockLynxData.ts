...
export const mockLynxHistory: LynxMessage[] = [
  ...
  },
  {
    ...
    timestamp: "10:42 AM",
    structuredResponse: {
      directAnswer: "No, sales are flat. EBITDA is inflated by $2.4M due to a manual reclassification of 'Cloud Hosting Costs' (OPEX) to 'Software Assets' (CAPEX) on Dec 28th.",
      canonBasis: {
        ...
        summary: "Canon CPX-SFT-001 strictly requires R&D timesheets to justify capitalizing software costs. Journal #J-9942 has ZERO linked timesheets."
      },
      standards: {
      ...
      siloDiagnosis: {
        ...
        description: "The 'Cloud Hosting' metadata was manually stripped by user CFO_ADJ_01. This indicates deliberate obfuscation to bypass OPEX budget limits."
      },
      risk: {
        types: ["Financial Misstatement", "Audit Failure"],
        impact: "This artificially boosts profit. External auditors will likely force a write-off, reversing this EBITDA gain and triggering a restatement."
      },
      nextSteps: [
