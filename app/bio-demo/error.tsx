      ...
      <Surface variant="base" className="p-8">
        <div className="text-center space-y-4">
          ...
          <Txt variant="body" className="text-text-secondary">
            {error.message || 'An unexpected error occurred while rendering the Generative UI'}
          </Txt>
          {error.digest && (
          ...
          <Txt variant="small" className="text-text-tertiary">
            This error occurred in the Biological UI Engine. Check the schema definition and data structure.
          </Txt>
