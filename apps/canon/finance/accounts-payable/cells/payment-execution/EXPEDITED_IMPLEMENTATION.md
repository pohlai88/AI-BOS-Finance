...
**File:** `apps/canon/finance/accounts-payable/cells/payment-execution/__tests__/integration/setup.ts`
...
**File:** `apps/canon/finance/accounts-payable/cells/payment-execution/__tests__/integration/payment-cell.integration.test.ts`
...
{
  "scripts": {
    "test:integration": "vitest run finance/accounts-payable/cells/payment-execution/__tests__/integration"
  }
}
```
