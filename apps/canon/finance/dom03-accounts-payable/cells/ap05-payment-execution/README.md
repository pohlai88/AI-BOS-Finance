...
```bash
# Run all AP-05 tests
pnpm test apps/canon/finance/dom03-accounts-payable/cells/payment-execution

# Run specific test file
pnpm test apps/canon/finance/dom03-accounts-payable/cells/payment-execution/__tests__/SoD.test.ts
```
