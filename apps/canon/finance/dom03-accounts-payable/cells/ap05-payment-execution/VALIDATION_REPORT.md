...
| D3 | `PaymentService` | `apps/canon/finance/ap/cells/payment-execution/` | ✅ `apps/canon/finance/dom03-accounts-payable/cells/payment-execution/PaymentService.ts` | ✅ Match |
| D4 | `ApprovalService` | `apps/canon/finance/ap/cells/payment-execution/` | ✅ `apps/canon/finance/dom03-accounts-payable/cells/payment-execution/ApprovalService.ts` | ✅ Match |
...
- **Domain Services** in `apps/canon/finance/dom03-accounts-payable/cells/payment-execution/`
