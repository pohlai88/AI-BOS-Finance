 ...
 * Canon: canon-finance
 * Location: apps/canon/finance/dom03-accounts-payable/payment-hub-demo
 */
...
app.get('/health', (_req: Request, res: Response) => {
  ...
  res.json({
    ...
    version: '1.0.0',
    location: 'apps/canon/finance/dom03-accounts-payable/payment-hub',
...
app.listen(PORT, () => {
  ...
  console.log(`   Location: apps/canon/finance/dom03-accounts-payable/payment-hub-demo`);
