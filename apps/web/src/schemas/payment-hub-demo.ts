 ...
 * Simplified schemas matching the Express backend API
...
// ============================================================================
// Payment Schemas (matching backend API)
// ============================================================================
...
export const PaymentHubCreateSchema = z.object({
  ...
  }).length(3, { message: 'Currency must be exactly 3 characters (e.g., USD)' }).describe('Currency code (e.g., USD)'),
...
// ============================================================================
// Cell Status Schemas (matching backend API)
// ============================================================================
...
export const CellSchema = z.object({
  ...
  description: z.string().describe('Cell description'),
});
