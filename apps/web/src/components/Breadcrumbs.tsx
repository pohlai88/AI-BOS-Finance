...
function generateBreadcrumbs(pathname: string): BreadcrumbItem[] {
  ...
  if (pathname.startsWith('/meta-')) {
    ...
    if (pathname === '/meta-architecture') {
      ...
      breadcrumbs.push({ label: 'Risk Radar', path: '/meta-risk', code: 'META_04' });
    } else if (pathname === '/meta-canon') {
      breadcrumbs.push({ label: 'Canon Matrix', path: '/meta-canon', code: 'META_05' });
    } else if (pathname === '/meta-health') {
      breadcrumbs.push({ label: 'Health Scan', path: '/meta-health', code: 'META_06' });
