          ...
          <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-[320px] h-[330px] flex items-end justify-center z-[100]">
            <svg width="320" height="330" viewBox="0 0 320 330" className="overflow-visible">
              ...
              >
                ...
                <circle cx="95" cy="259" r="1" fill="#86efac" opacity="0.5" />
              </motion.g>
              ...
              {rootPaths.slice(0, activeRootCount).map((root, i) => {
                ...
                return (
                  <g key={root.label}>
                    ...
                    <motion.path
                      d={`M${root.tipX},${root.tipY} Q ${root.tipX} ${root.tipY - 70} 200,0`}
                      fill="none"
                      stroke={root.color}
                      strokeWidth={1.6}
                      strokeLinecap="round"
                    ...
                    {active && (
                      ...
                      >
                        <animateMotion
                          ...
                          path={`M${root.tipX},${root.tipY} Q ${root.tipX} ${root.tipY - 70} 200,0`}
                        />
                      </motion.circle>
                    )}
                    ...
                    {/* label */}
                    <motion.text
                      x={labelLeft ? root.tipX - 78 : root.tipX + 14}
                      y={root.tipY + 3}
                      fontSize="9"
              ...
              {[
                {
                  ...
                  label: 'SEED',
                  color: 'emerald',
                  desc: 'Dormant genetic code. Blueprint encoded. Activation pending.',
                },
                {
                  id: '02',
                  label: 'SPROUT',
                  color: 'emerald',
                  desc: 'Root establishment. Foundation network. Structural integrity check.',
                },
                {
                  id: '03',
                  label: 'BLOOM',
                  color: 'pink',
                  desc: 'Signal broadcast. Cross-pollination enabled. Discovery active.',
                },
                {
                  id: '04',
                  label: 'FRUIT',
                  color: 'amber',
                  desc: 'Mature carrier. Provenance locked. Propagation ready.',
                },
              ].map((phase) => (
              ...
              {[
                {
                  ...
                  label: 'INGESTION',
                  color: 'emerald',
                  desc: 'Schema load. Cataloging begins. Fingerprint generated.',
                },
                {
                  id: '02',
                  label: 'ENRICHMENT',
                  color: 'emerald',
                  desc: 'Lineage mapped. Context assigned. Ownership tagged.',
                },
                {
                  id: '03',
                  label: 'ACTIVATION',
                  color: 'pink',
                  desc: 'Catalog published. Discovery enabled. Quality broadcasting.',
                },
                {
                  id: '04',
                  label: 'GOVERNANCE',
                  color: 'amber',
                  desc: 'Audit trail sealed. Derivation tracked. Trust verified.',
                },
              ].map((phase) => (
                <div key={phase.id} className="group">
                  <div className="flex items-baseline gap-3 mb-1.5">
