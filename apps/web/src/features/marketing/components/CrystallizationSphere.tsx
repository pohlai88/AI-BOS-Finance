  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto h-[600px] flex items-center justify-center overflow-visible">
      ...
      >
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  className="bg-surface-nested border border-primary p-4 rounded-full shadow-[0_0_30px_rgba(16,185,129,0.4)]"
                >
        ...
        <div className="absolute inset-[30%] bg-background rounded-full border border-white/10 flex items-center justify-center overflow-hidden">
          {/* Inner spinning core */}
          <motion.div
      ...
      <div className="absolute bottom-10 left-0 right-0 flex justify-center gap-12 text-xs font-mono tracking-widest">
        ...
        <div className={`flex items-center gap-2 transition-colors ${isFrozen ? 'text-primary' : 'text-white/20'}`}>
      ...
      {!isFrozen && (
        <motion.div
          ...
          transition={{ delay: 1 }}
        >
          <div className="bg-black/50 backdrop-blur-md border border-white/10 px-4 py-2 rounded-full text-xs font-mono text-text-secondary">
