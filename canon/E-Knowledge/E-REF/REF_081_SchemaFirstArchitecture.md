...
> **Related:** CONT_01_CanonIdentity, REF_082_PageCodingStandards  
> **Source:** Consolidated from `src/docs/02-architecture/schema-architecture.md` and `src/docs/01-architecture/SCHEMA_FIRST_ARCHITECTURE.md`  
> **Date:** 2025-01-27

---

# REF_081: Schema-First Architecture Guide

**Purpose:** Core architectural principle for NexusCanon - all UI components must be schema-driven  
**Status:** 🟢 Active  
...
**Status:** 🟢 Active  
**Related Documents:** REF_082_PageCodingStandards, CONT_01_CanonIdentity
